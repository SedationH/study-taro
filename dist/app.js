...
var _post = __webpack_require__(/*! ./post */ "./src/reducers/post.js");
...
function post() {
  ...
  switch (action.type) {
    case _index.SET_POSTS:
      {
        var _post = action.payload.post;

        return _extends({}, state, { posts: state.posts.concat(_post) });
      }

    case _index.SET_POST_FORM_IS_OPENED:
      {
    ...
    case _index.SET_LOGIN_INFO:
      {
        var _action$payload = action.payload,
            avatarUrl = _action$payload.avatarUrl,
        ...
        return _extends({}, state, { nickName: nickName, avatarUrl: avatarUrl });
      }
...
var middleware = [(0, _reduxLogger.createLogger)()];
