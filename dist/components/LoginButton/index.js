...
var LoginButton = (_temp2 = _class = function (_Taro$Component) {
  ...
  function LoginButton() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = LoginButton.__proto__ || Object.getPrototypeOf(LoginButton)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["$compid__21", "handleClick"], _this.customComponents = ["AtButton"], _temp), _possibleConstructorReturn(_this, _ret);
  }
